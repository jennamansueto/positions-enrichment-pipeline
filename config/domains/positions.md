...
| cftc_reportable | CFTC_REPORTABLE | CFTC_REPORT_FLAG | BOOLEAN | ACTIVE | Whether position is CFTC reportable |
| reporting_jurisdiction | REPORTING_JURIS | RPT_JURISDICTION | STRING | ACTIVE | Regulatory reporting jurisdiction (US, EU, UK, APAC) |
