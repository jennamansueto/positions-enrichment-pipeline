...
| carbon_intensity | CARBON_INTENSITY | DECIMAL(10,2) | ACTIVE | Carbon intensity (tCO2e per unit revenue) |
| esg_controversy_flag | ESG_CONTROVERSY_FLAG | BOOLEAN | ACTIVE | Whether security has ESG controversy |
| green_bond_flag | GREEN_BOND_FLAG | BOOLEAN | ACTIVE | Whether security is a green bond |
